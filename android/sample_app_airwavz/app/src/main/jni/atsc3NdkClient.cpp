...
std::string atsc3NdkClient::get_android_temp_folder() {
    ...
    jclass clazz = env.Get()->FindClass("com/airwavz/libatsc3/sampleapp/atsc3NdkClient");
...
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiInit(JNIEnv *env, jobject instance, jobject drvIntf)
{
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiInit: start init, env: %p\n", env);
    ...
    jclass jClazz = env->FindClass("com/airwavz/libatsc3/sampleapp/atsc3NdkClient");
    if (jClazz == NULL) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiPrepare(JNIEnv *env, jobject instance, jstring devlist_, jint d1, jint d2)
{
    printf("jni prepare\n");
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiFwLoad(JNIEnv *env, jobject instance, jlong key)
{
    printf("jni fwload\n");
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiOpen(JNIEnv *env, jobject instance, jint fd, jlong key)
{
    int bus = (key >> 8) & 0xFF;
    int addr = key & 0xFF;

    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiOpen: invoking open with fd: %d, key: %d, bus: %d, addr: %d",
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiTune(JNIEnv *env, jobject instance, jint freqKHz, jint plpid)
{
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiTune::tune\n");

    return api.Tune(freqKHz, plpid);
}

extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiStop(JNIEnv *env, jobject instance)
{
    printf("jni stop\n");
    return api.Stop();
}
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiClose(JNIEnv *env, jobject instance)
{
    printf("ApiClose:\n");
    return api.Close();
}
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiUninit(JNIEnv *env, jobject instance)
{
    printf("ApiUninit:\n");
    int r = api.Uninit();
...
extern "C" JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiReset(JNIEnv *env, jobject instance)
{
    printf("jni reset:\n");
    return api.Reset();
}
...
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiFindDeviceKey(JNIEnv *env, jobject instance, jboolean bPreBootDevice)
{
...
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1open_1for_1replay_1from_1assetManager(JNIEnv *env, jobject thiz, jstring filename_,
                                                        jobject asset_manager_weak) {
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1open_1for_1replay_1from_1assetManager\n");
    ...
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1open_1for_1replay_1from_1assetManager - return: %d\n", r);
    return r;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1thread_1run(JNIEnv *env, jobject thiz) {

    printf("::Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApPcapThreadRun\n");
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1thread_1stop(JNIEnv *env, jobject thiz) {

    printf("::Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1thread_1stop\n");
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1selectService(JNIEnv *env, jobject thiz,
                                                         jint service_id) {
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1selectService, service_id: %d\n", (int)service_id);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_ApiSetPLP(JNIEnv *env, jobject thiz, jintArray a_plp_ids) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1pcap_1open_1for_1replay(JNIEnv *env, jobject thiz,
                                                                  jstring filename_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1select_1additional_1service(JNIEnv *env,
                                                                                jobject thiz,
                                                                                jint service_id) {

    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1select_1additional_1service, additional service_id: %d\n", (int)service_id);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1clear_1additional_1service_1selections(
        JNIEnv *env, jobject thiz) {
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1clear_1additional_1service_1selections\n");
...
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1get_1sls_1metadata_1fragments_1content_1locations_1from_1monitor_1service_1id(JNIEnv *env, jobject thiz, jint service_id, jstring to_match_content_type_string) {
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1get_1sls_1metadata_1fragments_1content_1locations_1from_1monitor_1service_1id, service_id: %d\n", (int)service_id);
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1get_1sls_1route_1s_1tsid_1fdt_1file_1content_1locations_1from_1monitor_1service_1id(
        JNIEnv *env, jobject thiz, jint service_id) {
    printf("Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_atsc3_1slt_1alc_1get_1sls_1route_1s_1tsid_1fdt_1file_1content_1locations_1from_1monitor_1service_1id, service_id: %d\n", (int)service_id);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_airwavz_libatsc3_sampleapp_atsc3NdkClient_setRfPhyStatisticsViewVisible(JNIEnv *env, jobject thiz, jboolean is_rf_phy_statistics_visible) {
